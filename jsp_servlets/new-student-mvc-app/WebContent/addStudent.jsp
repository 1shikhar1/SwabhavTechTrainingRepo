...
<body>
	<form onsubmit="return validateForm()" action="addStudent"
		method="post">
		<label for="rollNo">Roll No:</label><br> 
		<input type="text" id="rollNo" name="rollNo"> <label for="rollNo" id="tick" style="color: green"></label><br>
		...
		<label for="fname">First name:</label><br> <input type="text"
			...
			name:</label><br> <input type="text" id="lname" name="lname"><br>
		<br> <label for="cgpa">CGPA:</label><br> <input type="text"
			id="cgpa" name="cgpa"><br>
		<br>
